...
//variaveis para criar as classes necessarias para conectar executar e trazer dados do mysql
    ...
    private void pesquisar_cliente() {
        String sql = "select idcli as Id, nomecli as Nome, fonecli as Fone from tbclientes where nomecli like ?"; //instruão para mudar os nomes das tabelas

        try {
            pst = conexao.prepareStatement(sql);
            pst.setString(1, txtCliPesquisar.getText() + "%"); // +"%" é a continuação da instrção sql
            rs = pst.executeQuery();
    ...
    // metodo para setar campos no id da tabela
    private void setar_campos() {
        int setar = tblClientes.getSelectedRow();
        txtCliId.setText(tblClientes.getModel().getValueAt(setar, 0).toString());// o número 0 corresponde a posição idcli na tbClientes do sql.
    }
    ...
    private void emitir_os() {
        ...
        try {
            ...
            pst.setString(7, txtOsValor.getText().replace(",", "."));// substitui a virgula pelo ponto
    ...
    private void pesquisar_os() {
        ...
        try {
            ...
            if (rs.next()) {
                ...
                String rbtTipo = rs.getString(3); // recebe o conteudo do campo tipo
            ...
            //trata o erro abaixo que é causado pela digitação da OS inválida ex. 
        } catch (com.mysql.jdbc.exceptions.jdbc4.MySQLSyntaxErrorException e) {
            JOptionPane.showMessageDialog(null, "OS inválida");//mensagem caso a OS pesquisada seja letras
    ...
    private void imprimir_os(){
        ...
        if(confirma == JOptionPane.YES_OPTION){
            //imprimindo relatório com o framework com o JasperReports
            try {
                //usando a classe HashMap Para criar um filtro
                HashMap filtro = new HashMap();
                filtro.put("os", Integer.parseInt(txtOs.getText()));
                //usando a classe JasperPrint para preparar a impressao de uma OS
    ...
    private void initComponents() {
        ...
        txtOs.setBackground(new java.awt.Color(204, 204, 255));
        txtOs.setFont(new java.awt.Font("Tahoma", 1, 8)); // NOI18N
        ...
        rbtOs.setText("Ordem de Serviços");
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(txtOs, javax.swing.GroupLayout.PREFERRED_SIZE, 21, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        .addComponent(txtCliPesquisar, javax.swing.GroupLayout.PREFERRED_SIZE, 190, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
    ...
    private void formInternalFrameOpened(javax.swing.event.InternalFrameEvent evt) {//GEN-FIRST:event_formInternalFrameOpened
        // ao abrir o forme marcar o radio buton orçamento:
        rbtOrc.setSelected(true);
        tipo = "Orçamento";
    }//GEN-LAST:event_formInternalFrameOpened

    private void btnOsAdicionarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnOsAdicionarActionPerformed
        // ao clicar no botao chamar o metodo os
        emitir_os();
    ...
    private void btnOsExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnOsExcluirActionPerformed
        // chamando o método para excluír uma OS
        excluir_os();
