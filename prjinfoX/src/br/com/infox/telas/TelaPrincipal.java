...
public class TelaPrincipal extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        imgX.setIcon(new javax.swing.ImageIcon(getClass().getResource("/br/com/infox/icones/x.png"))); // NOI18N
        imgX.setToolTipText("");
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(imgX, javax.swing.GroupLayout.PREFERRED_SIZE, 218, javax.swing.GroupLayout.PREFERRED_SIZE))
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addComponent(imgX, javax.swing.GroupLayout.PREFERRED_SIZE, 234, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(29, 29, 29))
        );

        setSize(new java.awt.Dimension(915, 556));
...
//as linhas abauixo abrir o form tela usuario dentro do desktop pane
...
// as linhas abaixo substituem a label lblData pela data atual do
        ...
        Date data = new Date ();
        //as linhas abaixo setam a variavel data para a lbldata
        DateFormat formatador = DateFormat.getDateInstance(DateFormat.SHORT); // biblioteca para formatar data
        lblData.setText(formatador.format(data)); // ao carregar o form troca a label data pela data do sistema.
    }//GEN-LAST:event_formWindowActivated

    private void MenOpcSaiActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MenOpcSaiActionPerformed
        // exibe uma caixa de dialogo ao clicar em opçoes > sair
        int sair = JOptionPane.showConfirmDialog(null,"Tem certeza que deseja sair?", "Atenção", JOptionPane.YES_NO_OPTION);
        if (sair ==  JOptionPane.YES_OPTION){//se usuário clicar em sim o sistema fecha
            System.exit(0);
        }
    }//GEN-LAST:event_MenOpcSaiActionPerformed

    private void MenCadCliActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MenCadCliActionPerformed
        // As linhas abaixo abrir o form TelaCadastro dentro do desktop pane
    ...
    private void menRelCliActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_menRelCliActionPerformed
        ...
        if(confirma == JOptionPane.YES_OPTION){
            //emitindo relatório com o framework com o JasperReports
            try {
